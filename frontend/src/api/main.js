...
const specialIpcRoute = {
  ...
  getConfig: 'controller.index.getConfig',
  startJavaServer: 'controller.index.startJavaServer',
  closeJavaServer: 'controller.index.closeJavaServer',
  mysqlRunStatus: 'controller.index.mysqlRunStatus',
}
